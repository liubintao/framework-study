...
import com.robust.study.netty.lion.api.spi.handler.BindValidator;
import com.robust.study.netty.lion.api.spi.handler.BindValidatorFactory;
import com.robust.study.netty.lion.common.handler.BaseMessageHandler;
import com.robust.study.netty.lion.common.message.BindUserMessage;
...
import com.robust.study.netty.lion.core.router.LocalRouter;
import com.robust.study.netty.lion.core.router.LocalRouterManager;
...
public final class BindUserHandler extends BaseMessageHandler<BindUserMessage> {
    ...
    private void bind(BindUserMessage message) {
        if (StringUtil.isBlank(message.userId)) {
