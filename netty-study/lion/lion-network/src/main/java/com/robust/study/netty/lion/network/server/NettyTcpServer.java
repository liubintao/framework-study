package com.robust.study.netty.lion.network.server;
...
import com.robust.study.netty.lion.api.service.ServiceException;
import com.robust.study.netty.lion.network.codec.PacketDecoder;
import com.robust.study.netty.lion.network.codec.PacketEncoder;
 ...
 * @Description:
 * @Author: robust
 * @CreateDate: 2019/8/29 17:15
 * @Version: 1.0
 */
public abstract class NettyTcpServer extends BaseService implements Server {

    private final Logger logger = LoggerFactory.getLogger(NettyTcpServer.class);
    ...
    private void createEpollServer(Listener listener) {
        ...
        createServer(listener, bossGroup, workerGroup, EpollServerDomainSocketChannel::new);
    }
    ...
    private void createServer(Listener listener, EventLoopGroup boss, EventLoopGroup worker,
        ...
        try {
             ...
             * 绑定端口并启动去接收进来的连接
             */
            InetSocketAddress address = StringUtil.isBlank(host)
