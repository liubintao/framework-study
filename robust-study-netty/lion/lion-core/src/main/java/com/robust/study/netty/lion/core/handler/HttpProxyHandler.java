...
import com.robust.study.netty.lion.api.spi.net.DnsMapping;
...
import com.robust.study.netty.lion.common.message.HttpRequestMessage;
import com.robust.study.netty.lion.common.message.HttpResponseMessage;
import com.robust.study.netty.lion.core.LionServer;
import com.robust.study.netty.lion.network.http.HttpCallback;
import com.robust.study.netty.lion.network.http.HttpClient;
import com.robust.study.netty.lion.network.http.RequestContext;
...
public class HttpProxyHandler extends BaseMessageHandler<HttpRequestMessage> {
    ...
    public void handle(HttpRequestMessage message) {
        try {
            ...
            HttpResponseMessage
                    ...
                    .sendRaw();
            log.error("send request ex, message=" + message, e);
    ...
    private static class DefaultHttpCallback implements HttpCallback {
        ...
        public DefaultHttpCallback(HttpRequestMessage request) {
        ...
        public void onException(Throwable throwable) {
            ...
            log.error("send proxy request ex end request={}, response={}", request, 502, throwable);
