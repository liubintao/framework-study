...
import static com.robust.study.netty.lion.tools.config.CC.lion.net.gateway_server_bind_ip;
import static com.robust.study.netty.lion.tools.config.CC.lion.net.gateway_server_port;
import static com.robust.study.netty.lion.tools.config.CC.lion.net.traffic_shaping.gateway_server.*;
import static com.robust.study.netty.lion.tools.config.CC.lion.net.write_buffer_water_mark.gateway_server_high;
import static com.robust.study.netty.lion.tools.config.CC.lion.net.write_buffer_water_mark.gateway_server_low;
...
public final class GatewayServer extends NettyTcpServer {
    ...
    protected void initOptions(ServerBootstrap b) {
        ...
        if (CC.lion.net.snd_buf.gateway_server > 0)
            b.childOption(ChannelOption.SO_SNDBUF, CC.lion.net.snd_buf.gateway_server);
        if (CC.lion.net.rcv_buf.gateway_server > 0)
            b.childOption(ChannelOption.SO_RCVBUF, CC.lion.net.rcv_buf.gateway_server);
        /**
