package com.robust.study.netty.lion.cache.redis.connection;
...
public class RedisConnectionFactory {
    ...
    private Pool<Jedis> createPool() {
        if (StringUtil.isNotBlank(sentinelMaster)) {
    ...
    protected Pool<Jedis> createRedisSentinelPool() {
        ...
        return new JedisSentinelPool(
                sentinelMaster, hostAndPorts, poolConfig, shardInfo.getSoTimeout(), shardInfo.getPassword());
    }
